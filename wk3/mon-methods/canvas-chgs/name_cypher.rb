def main
    ...
    # Steps:
    # Prompt the user for their name. If the user’s name is shorter than 4 characters, tell them to enter a longer name.
    ...
    # The cypher is this:
    # Swap the first and last 2 letters of the name - for example, “jessica” should be encrypted as “cassije” and “cassije” should be decrypted as “jessica”
